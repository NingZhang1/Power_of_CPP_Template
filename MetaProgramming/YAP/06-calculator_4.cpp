...
// Look! A transform!  This one transforms the expression tree into the arity, i.e. the number of arguments
...
struct get_arity
{
    ...
    {
        return boost::hana::llong_c<I>; /// return the indx of the placeholder
    }
    ...
    auto operator()(boost::yap::expr_tag<boost::yap::expr_kind::terminal>, T &&)
    {
        ...
        return 0_c; /// this is not a placeholder so it does not contribute to arity
    }
